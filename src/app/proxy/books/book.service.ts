import type { AuthorLookupDto, BookDto, CreateUpdateBookDto, ShelfLookupDto } from './models';
...
export class BookService {
  ...
  getShelfLookup = () =>
    this.restService.request<any, ListResultDto<ShelfLookupDto>>({
      method: 'GET',
      url: '/api/app/book/shelf-lookup',
    },
    { apiName: this.apiName });
